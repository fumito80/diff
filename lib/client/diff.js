...
function diff(a, b) {
  ...
  return new Promise(resolve => {
    const thOnp = threads_1.default.spawn('thOnp.js');
    const promiseOnp = thOnp.send(['R', nR, {
      source,
      delta,
      offset,
      rangeKN,
    ...
    const headL = Onp(source, offset, delta, rangeKN, rangeKM)(exports.Snakes['L'](nL));
    promiseOnp.then(headR => {
      ...
      if (!newHeadR || headL.x >= m && headL.y >= n) {
        ...
        const thResult = threads_1.default.spawn('thResult.js');

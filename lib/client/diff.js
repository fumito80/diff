    ...
    return new Promise(resolve => {
      workerHeadR.on('message', headR => {
        if (headL.x >= m && headL.y >= n) {
          ...
          const workerResultL = new Worker(__dirname + '/thResult.js', {
            workerData: ['L', source, headL]
          });
          const resultR = pipe(getHeadR(source, headL), unifiedResult(exports.unifieds.L(source), []))(headR);
